...
### Preface
As an academic discipline and millennium-defining global technology, computer networking, the simple act of computers sharing information, is an intriguing topic to examine. It's an extremely convoluted one, as well, as its creation followed no definitive roadmap nor had a singular author. Consequently, the technology relies on a heterogeneous mixture of protocols, created by many institutions but in a cooperative, standards-based way. The Internet can be as much a lesson in 21st techno-bureaucracy, both corporate and academic, as much as it is the technical disciple of organizing 0s and 1s for transmission and reception. 

Studying an immense topic like the internet can feel overwhelming, after all, it's a technology that has expanded to serve 5.07 billion people daily—that's 63.5% of the population! Choosing to study its history first is a good idea as it can be a point of departure that is both an interesting introductory lesson and illustrative of foundational knowledge. Below will be a cursory review of the internet's history, relating it to the present to hopefully bring a fresher perspective to the modern technologies we take advantage of--and for granted, today. 

After the history review, I will discuss what I have found about the start of the internet and then discuss the construction and implementation of a private computer network for enterprise applications. 

I will detail the major steps: connecting to an ISP, setting up a private access point, and ultimately running several networking-centric enterprise technologies such as:
...
If you want to listen to the transmission of sound there needs to be air, to carry the sound energy, and an ear or otherwise device to “hear” the noise. A simple form of noise creations, banging to things together, creates a [mechanical wave](https://www.wikiwand.com/en/Mechanical_wave). Armed with this information, we can give answer to the parable:

    "If a tree falls in a forest and no one is around to hear it, does it make a sound?"

    1) Yes, a sound will be made as the mechanical wave propogates itslef on nearby mediums like air or tree bark reverberating etc.
...
<Image alt="pline" src="/static/images/pline.webp" width={256} height={128} />
<p>
...
### References
[^1]: https://www.wikiwand.com/en/Quantification%20(science)