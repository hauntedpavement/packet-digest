...
- software defined routing via Intel NIC card + old pc + pfSense  
- Hypervisor ProxMox with Windows Server 2019 & Security Onion (Wazuh)
- pfSense addons pfBlocker, Tailscale (VPN), Suricata

hopefully reflecting with lessons learned along the way, to frame the process as an educational exercise.
