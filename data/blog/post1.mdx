...
### Preface
The internet stands for many things; a testament to the value of government-aided technological progress; 21st-century "design by committee" innovation; the new "electricity"; it was a lot of things, the technology that heralded in the information age. And analogous to the modern age, it's also complicated and dynamic, an ever-moving target of human innovation. Computer networking, the simple act of computers exchanging information, is an intriguing topic to examine. 

Tracing its development becomes convoluted quickly, as its creation followed no definitive roadmap nor had a singular inventor. The internet, like the culture it gave rise to, emanated from a cluster of smaller projects that had their roots in advancing telecommunications. Consequently, the internet is a jigsaw puzzle of protocols, created by many individual institutions to be later unified and coordinated by a central authority. Viewed this way, the Internet can be as much a lesson in 21st techno-bureaucracy, as it is in the technical disciple of organizing 0s and 1s for transmission and reception. 

Studying an immense topic like the internet can feel overwhelming, after all, it's a technology that has expanded to serve 5.07 billion people daily—that's 63.5% of the population! Choosing to study its history first is a good idea as it can be a point of departure that is both an interesting introductory lesson and illustrative of foundational knowledge. Below will be a cursory review of the internet's history, relating it to the present to hopefully bring perspective to the modern technologies we take advantage of--and for granted, today. 
